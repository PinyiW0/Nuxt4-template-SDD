...
| 5 | 頁面實作 | 逐一填充 pages 內容 | [phase-5](references/phase-5-pages.md) + [decision-tiers.md](references/decision-tiers.md) + [page-builder.md](references/page-builder.md) + [rules.md `[P5]`](references/rules.md) + visual-hierarchy.md + frontend-security.md（選讀：components.md、features.md） |
...
> route-map 頁數 > 10 時讀 [phase-5-fanout.md](references/phase-5-fanout.md)，改採模組級 worktree 扇出。
